...
const skills = {
  ...
  frontend: [
    ...
    { name: "Shadcn / MUI", icon: "UI", color: "text-white" },
  ],
  backend: [
    { name: "Express.js", icon: "EX", color: "text-gray-300" },
    { name: "PostgreSQL / MySQL", icon: "🐘", color: "text-blue-400" },
    { name: "MongoDB", icon: "🍃", color: "text-green-500" },
    { name: "Supabase", icon: "⚡", color: "text-green-400" },
    { name: "Prisma ORM", icon: "🔺", color: "text-white" },
    { name: "Redis", icon: "🔴", color: "text-red-400" },
    { name: "REST / GraphQL", icon: "🔷", color: "text-pink-400" },
    { name: "WebSockets / n8n", icon: "⚙️", color: "text-orange-400" },
    { name: "OAuth / JWT", icon: "🔐", color: "text-yellow-400" },
    { name: "Kafka / RabbitMQ", icon: "📨", color: "text-purple-400" },
    { name: "Firebase", icon: "🔥", color: "text-orange-400" },
  ],
  tools: [
    { name: "AWS / GCP", icon: "☁️", color: "text-orange-300" },
    { name: "Docker", icon: "🐳", color: "text-blue-400" },
    { name: "Vercel / Netlify", icon: "▲", color: "text-white" },
    { name: "Git / CI/CD", icon: "⚡", color: "text-gray-300" },
    { name: "Figma / Framer", icon: "🎨", color: "text-purple-400" },
    { name: "Jest / Playwright", icon: "🎭", color: "text-green-500" },
    { name: "Agile / Scrum", icon: "🔄", color: "text-blue-300" },
  ]
};
